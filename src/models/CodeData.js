const echoesOfTheUnderHallsCodeData = `using UnityEngine;
...
public class Bullet : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.gameObject.CompareTag("Wall") || collision.gameObject.CompareTag("Enemy") || collision.gameObject.CompareTag("Boss")) asd asd asd asd asd asd asd asd asd asd asd asd asd asd asd asd asd asd asds
        {
...
export default echoesOfTheUnderHallsCodeData
